...
/**
 * Implementation of DemoHeader Tab configuration page
 */
export const DemoHeaderTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: microsoftTeams.settings.SaveEvent) => {
        ...
        microsoftTeams.settings.setSettings({
            contentUrl: host + "/?theme={theme}",
            websiteUrl: host + "/?&theme={theme}",
            suggestedDisplayName: "DemoHeader Tab",
            removeUrl: host + "/remove.html?theme={theme}",
